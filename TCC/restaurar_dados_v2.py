#!/usr/bin/env python3
"""Script para restaurar/corrigir dados com encoding UTF-8 correto - Version 2"""
...
def restaurar_dados():
    ...
    try:
        ...
        cursor.execute("ALTER TABLE evento AUTO_INCREMENT = 1")
        cursor.execute("ALTER TABLE sessoes AUTO_INCREMENT = 1")
        
        # Inserir dados de teste
        print("Inserindo dados de exemplo com UTF-8...")
        
        # Usuários (CPF como INT)
        usuarios = [
        ...
        # Sessões (ID AUTO-INCREMENT, relacionadas a eventos)
        sessoes = [
            ('Abertura e Visão do Futuro', '09:00', '10:00', 'Prof. Carlos Silva', 'Boas-vindas e perspectivas da semana', event_ids[0]),
            ('Tendências em Tecnologia', '10:30', '12:00', 'Dra. Ana Santos', 'Discussão sobre tecnologias emergentes', event_ids[0]),
            ('Fundamentos de IA', '14:00', '15:30', 'Prof. João Luis', 'Introdução aos conceitos de IA', event_ids[1]),
            ('Machine Learning na Prática', '16:00', '17:30', 'Dr. Ricardo Costa', 'Casos de uso reais de ML', event_ids[1]),
        ]
        ...
        print("  ✓ Inscrições inseridas")
        
        conn.commit()
        cursor.close()
        conn.close()
        
        print("\n✓ Dados restaurados com sucesso em UTF-8!")
        print("\nEventos criados com IDs:", event_ids)
